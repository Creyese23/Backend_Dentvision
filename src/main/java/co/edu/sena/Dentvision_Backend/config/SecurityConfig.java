...
public class SecurityConfig {
    ...
    // Orígenes permitidos desde .env → CORS_ALLOWED_ORIGINS (ej: "http://localhost:5173,https://app.tudominio.com")
    @Value("${cors.allowed-origins:http://localhost:5173,http://localhost:5174,http://localhost:5175,http://localhost:3000,http://127.0.0.1:5173,http://127.0.0.1:5174}")
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        // Los preflight OPTIONS deben pasar sin autenticación
